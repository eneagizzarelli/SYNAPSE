...
from client_data import get_client_ip, write_client_MAC, write_client_geolocation, increment_client_number_of_connections, write_client_session_duration_in_seconds

def main():
    client_ip = get_client_ip()
    write_client_MAC(client_ip)
    write_client_geolocation(client_ip)
