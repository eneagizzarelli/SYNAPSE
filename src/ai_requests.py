...
def generate_tab_completions(text):
    messages = ["Hello!", "How are you?", "I'm fine, thank you!", text]
    print(messages)
    response = openai.chat.completions.create(model = model, messages = messages, temperature = 0.0, max_tokens = 500, n = 5)
