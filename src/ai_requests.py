...
def completer(text, state):
    ...
    prompt = "Emulate the tab autocompletion of a Linux terminal. Generate many words separated by '\n' to complete the already started one. If you don't know what to answer, do not print anything. Do not start in any case a conversation with the user. A terminal would not do so. Start from the following text: {text} and complete it. "
